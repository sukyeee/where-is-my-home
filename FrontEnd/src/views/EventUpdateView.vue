  ...
  <div class="event">
    ...
    <div class="view-content">
      ...
      <div class="container d-flex flex-wrap flex-column">
        ...
        <base-button @click="eventUpdate" class="mt-3 w-25 form-group mx-auto">등록</base-button>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    initUI() {
      ...
      this.CKEditor.setData(this.$store.state.events.content);
      this.category = this.$store.state.events.category;

      this.startDate = this.$store.getters.getStartDateAndTime;
      this.endDate = this.$store.getters.getEndDateAndTime;
