            ...
            <template>
              ...
              <form role="form">
                ...
                <div class="text-center">
                  <base-button type="default" class="my-4 col-12" @click="login"
                    >로그인</base-button
                  >
                </div>
              </form>
      ...
      >
        <template>
          ...
          <form role="form">
            ...
            <div class="text-center">
              <base-button type="primary" class="my-4" @click="findPassword"
                >비밀번호 찾기</base-button
              >
            </div>
          </form>
    ...
    async findPassword() {
      try {
        ...
        if (data.result == "login") {
          ...
          alertify.success(
            `${data.UserDto.userName}고객님의 비밀번호는 ${data.UserDto.userPassword}  입니다`
          );
        }
      } catch (error) {
        console.log(error);
