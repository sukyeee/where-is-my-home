          ...
          <div class="col-lg-12">
            <div class="row row-grid">
              ...
              <div
                ...
                v-for="(bookmark, index) in bookmarkBodyList"
                :key="index"
              >
                <div>
                  <card class="border-0" hover shadow>
                    <i
                      class="fa fa-times display-4 pt-1 d-flex justify-content-end"
                      style="cursor: pointer"
                      @click="bookmarkDelete(bookmark.bookmarkId)"
                    ></i>

                    <div @click="bookmarkDetail(bookmark)" style="cursor: pointer">
                      <div
                        class="event-thumbnail"
                        :data-join="bookmark.joinTag"
                        :data-ended="bookmark.isEnded"
                      >
                        <div class="event-thumbnail-image">
                          <!-- <img :src="board.thumbnailImage" /> -->
                          <img
                            src="../../../public/img/theme/house.jpg"
                            alt="매물 이미지.."
                            class="mt-4 mb-2"
                          />
                        </div>
                    ...
                    <div class="row d-flex justify-content-center">
                      <input
                        type="checkbox"
                        class="my-checkbox mb-3 d-flex justify-content-center mt-2"
                        :value="bookmark.houseDealId"
                        ealId
  ...
  methods: {
    ...
    async bookmarkDetail(bookmark) {
      ...
      this.$store.commit("SET_SEARCH_LIST", {
        houseId: bookmark.houseId,
        houseDealId: bookmark.houseDealId,
      });
