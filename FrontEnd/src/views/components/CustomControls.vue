    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          ...
          <base-checkbox class="mb-3" v-model="checkboxes.unchecked"> Unchecked </base-checkbox>
          <base-checkbox class="mb-3" v-model="checkboxes.checked"> Checked </base-checkbox>
        ...
        <div class="col-lg-3 col-sm-6 mt-4 mt-md-0">
          ...
          <base-radio name="radio1" class="mb-3" v-model="radio.radio1"> Checked </base-radio>
