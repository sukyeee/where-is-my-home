                ...
                <div class="w-100 ml-3">
                  ...
                  <div class="d-flex mt-1 align-items-center">
                    ...
                    >
                      ...
                      <i
                        v-show="bookmark.houseDealId == house.houseDealId"
                        class="ni ni-favourite-28 text-danger display-4 pt-1 favorite"
                        @click="bookmarkInsert(house.houseDealId)"
                      ></i>
