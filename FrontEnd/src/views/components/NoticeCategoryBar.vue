  ...
  <div class="container">
    <div class="row mb-3">
      ...
      <div class="col-lg-6 col-sm-8 d-flex">
        ...
        <!-- <router-link :to="{ name: 'notice-input' }" class="form-group w-20"> -->
...
export default {
  ...
  methods: {
    routeToInsertView() {
      // this.$store.dispatch('noticeInit');
      this.$router.push({ name: "notice-input" });
    },
    getAllList() {
      this.code = "";
      this.searchWord = "";
    ...
    getList() {
      this.$store.commit("SET_NOTICE_CODE", { code: this.code });
      this.$store.commit("SET_NOTICE_SEARCH_WORD", { searchWord: this.searchWord });
