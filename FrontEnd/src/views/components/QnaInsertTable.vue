          ...
          <template>
              ...
              <form role="form">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="제목을 입력해주세요." aria-label="Username" aria-describedby="basic-addon1" v-model=title>
                  </div>

                  <div class="mb-3">
                    <label for="qnaDetailContent" class="form-label">문의 내용</label>
                    <textarea class="form-control" rows="7"  placeholder="내용을 입력해주세요." id="exampleFormControlTextarea1"  v-model=content></textarea>
                  </div>
