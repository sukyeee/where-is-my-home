<template>
  <div>
        ...
        <div class="d-flex w-100 justify-content-between">
          <h6 class="mb-0">
            {{ comment.userName }} &nbsp;<small
              >{{ comment.registerDate.date.year }}/ {{ comment.registerDate.date.month }}/{{
                comment.registerDate.date.day
              }}</small
            >
          </h6>
    ...
    <div class="row justify-content-end">
      <base-button
        type="bg-secondary"
        class="btn-sm mr-3 row justify-content-end"
        @click="replyBtn(comment.commentId)"
        >답글</base-button
      >
    </div>
